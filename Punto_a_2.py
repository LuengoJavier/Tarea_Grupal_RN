...
save_dir = os.path.join(os.getcwd(), 'saved_models_'+ str(epochs) +'_epocas'+'_0.5_compression_factor')
model_name = 'FER2013_densenet_model_compression_factor_0.5.{epoch:02d}.h5'
...
plt.savefig('funcion_perdida_modelo_densenet_0.5.png')
##-------------------
...
plt.savefig('funcion_exactitud_modelo_densenet_0.5.png')